...
// @downloadURL  https://raw.githubusercontent.com/LiarCoder/TampermonkeyScripts/main/scripts/beautify-code-block-font-style/dist/beautify-code-block-font-style.user.js
// @updateURL    https://raw.githubusercontent.com/LiarCoder/TampermonkeyScripts/main/scripts/beautify-code-block-font-style/dist/beautify-code-block-font-style.user.js
// @match        *://*/*
// @grant        none
// ==/UserScript==
...
(function () {
  ...
  const siteSelectors = {
    ...
    // 博客园代码块
    cnblogs: ".syntaxhighlighter a, .syntaxhighlighter div, .syntaxhighlighter code, .syntaxhighlighter table, .syntaxhighlighter table td, .syntaxhighlighter table tr, .syntaxhighlighter table tbody, .syntaxhighlighter table thead, .syntaxhighlighter table caption, .syntaxhighlighter textarea",
    // LeetCode代码块
    leetcode: ".notranslate, pre, .inner-wrapper__1TvQ",
    // GitHub代码块
    github: ".blob-code-inner, .blob-code-inner > *, .CodeMirror pre > span, .CodeMirror-linenumber",
    // 菜鸟教程代码块
