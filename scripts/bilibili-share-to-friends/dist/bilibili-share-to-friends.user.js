...
(function () {
  ...
  const md5 = (input) => {
    ...
    const round = (fn, a3, b3, c3, d3, x2, s2, ac) =>
      addUnsigned(
        rotateLeft(addUnsigned(addUnsigned(a3, fn(b3, c3, d3)), addUnsigned(x2, ac)), s2),
        b3
      );
  ...
  const assertSuccess = (result, action) => {
    if (!result || result.code !== 0) {
      const message =
        (result == null ? void 0 : result.message) ||
        (result == null ? void 0 : result.msg) ||
        "未知错误";
      throw new Error(
        `${action}失败：${message}（code: ${(result == null ? void 0 : result.code) ?? "-"}）`
      );
    }
    return result.data;
  };
  ...
  const signWbi = (params, wbiImg) => {
    if (
      !(wbiImg == null ? void 0 : wbiImg.img_url) ||
      !(wbiImg == null ? void 0 : wbiImg.sub_url)
    ) {
      return params;
    }
  ...
  const getSessionAccountInfo = (session, accountInfoMap = {}) => {
    ...
    return (
      session.account_info || accountInfoMap[talkerId] || accountInfoMap[Number(talkerId)] || {}
    );
  };
  ...
  const getFollowings = ({ mid, page = 1, pageSize = RELATION_PAGE_SIZE }) =>
    getRelationUsers({
      action: "获取我的关注",
  ...
  const searchFollowings = ({ mid, keyword, page = 1, pageSize = RELATION_PAGE_SIZE }) =>
    getRelationUsers({
      action: "搜索我的关注",
  ...
  const getFollowers = ({ mid, page = 1, pageSize = RELATION_PAGE_SIZE }) =>
    getRelationUsers({
      action: "获取我的粉丝",
...
https://www.bilibili.com/video/${video.bvid}`,
  ...
  function A$1(n2) {
    ((!n2.__d && (n2.__d = true) && i$1.push(n2) && !H.__r++) || r$1 != l$1.debounceRendering) &&
      ((r$1 = l$1.debounceRendering) || o$1)(H);
  }
  function H() {
    try {
      for (var n2, l2 = 1; i$1.length; )
        (i$1.length > l2 && i$1.sort(e$1), (n2 = i$1.shift()), (l2 = i$1.length), I(n2));
    } finally {
      i$1.length = H.__r = 0;
    }
  }
  function L(n2, l2, u2, t2, i2, r2, o2, e2, f2, c2, a2) {
    var s2,
      ...
      m2 = (t2 && t2.__k) || w$1,
      b2 = l2.length;
    for (f2 = T$1(u2, l2, m2, f2, b2), s2 = 0; s2 < b2; s2++)
      null != (p2 = u2.__k[s2]) &&
        ((h2 = (-1 != p2.__i && m2[p2.__i]) || d$1),
        (p2.__i = s2),
        (_2 = q$1(n2, p2, h2, i2, r2, o2, e2, f2, c2, a2)),
        (v2 = p2.__e),
        p2.ref &&
          h2.ref != p2.ref &&
        ...
        (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k
          ? ((f2 = j$1(p2, f2, n2, g2)), g2 && h2.__e && (h2.__e = null))
          : "function" == typeof p2.type && void 0 !== _2
            ? (f2 = _2)
            : v2 && (f2 = v2.nextSibling),
        (p2.__u &= -7));
    return ((u2.__e = y2), f2);
  }
    ...
    for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++)
      null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2
        ? ("string" == typeof o2 ||
          ...
          (o2.__b = n2.__b + 1),
          (e2 = null),
          -1 != (c2 = o2.__i = O(o2, u2, f2, s2)) && (s2--, (e2 = u2[c2]) && (e2.__u |= 2)),
          null == e2 || null == e2.__v
            ? (-1 == c2 && (i2 > a2 ? h2-- : i2 < a2 && h2++),
              "function" != typeof o2.type && (o2.__u |= 4))
            : c2 != f2 &&
              (c2 == f2 - 1 ? h2-- : c2 == f2 + 1 ? h2++ : (c2 > f2 ? h2-- : h2++, (o2.__u |= 4))))
        : (n2.__k[r2] = null);
    if (s2)
      for (r2 = 0; r2 < a2; r2++)
  ...
  function j$1(n2, l2, u2, t2) {
    ...
    if ("function" == typeof n2.type) {
      for (i2 = n2.__k, r2 = 0; i2 && r2 < i2.length; r2++)
        i2[r2] && ((i2[r2].__ = n2), (l2 = j$1(i2[r2], l2, u2, t2)));
      return l2;
    }
    n2.__e != l2 &&
      (t2 && (l2 && n2.type && !l2.parentNode && (l2 = $(n2)), u2.insertBefore(n2.__e, l2 || null)),
      (l2 = n2.__e));
    do {
  ...
  function z$1(n2, l2, u2) {
    "-" == l2[0]
      ...
      : (n2[l2] = null == u2 ? "" : "number" != typeof u2 || _$1.test(l2) ? u2 : u2 + "px");
  }
    ...
    n: if ("style" == l2)
      if ("string" == typeof u2) n2.style.cssText = u2;
        ...
        if (("string" == typeof t2 && (n2.style.cssText = t2 = ""), t2))
          for (l2 in t2) (u2 && l2 in u2) || z$1(n2.style, l2, "");
        if (u2) for (l2 in u2) (t2 && u2[l2] == t2[l2]) || z$1(n2.style, l2, u2[l2]);
      }
    else if ("o" == l2[0] && "n" == l2[1])
      ((r2 = l2 != (l2 = l2.replace(s$1, "$1"))),
        (o2 = l2.toLowerCase()),
        ...
        u2
          ? t2
            ? (u2[a$1] = t2[a$1])
            : ((u2[a$1] = h$1), n2.addEventListener(l2, r2 ? v$1 : p$1, r2))
          : n2.removeEventListener(l2, r2 ? v$1 : p$1, r2));
    else {
    ...
    n: if ("function" == typeof T2)
      try {
        if (
          ...
          t2.__c
            ? (_2 = (h2 = u2.__c = t2.__c).__ = h2.__E)
            : (x2
                ? (u2.__c = h2 = new T2(k2, $2))
                : ((u2.__c = h2 = new C$1(k2, $2)), (h2.constructor = T2), (h2.render = Q)),
              M && M.sub(h2),
              h2.state || (h2.state = {}),
              (h2.__n = i2),
              (p2 = h2.__d = true),
          ...
          x2 &&
            ...
            (h2.__s == h2.state && (h2.__s = m$1({}, h2.__s)),
            m$1(h2.__s, T2.getDerivedStateFromProps(k2, h2.__s))),
          (v2 = h2.props),
          (y2 = h2.state),
          (h2.__v = u2),
          p2)
          ...
          if (
            ...
            (u2.__v != t2.__v && ((h2.props = k2), (h2.state = h2.__s), (h2.__d = false)),
              (u2.__e = t2.__e),
              (u2.__k = t2.__k),
              u2.__k.some(function (n3) {
                n3 && (n3.__ = u2);
              }),
              w$1.push.apply(h2.__h, h2._sb),
              (h2._sb = []),
        ...
        ((h2.state = h2.__s),
          null != h2.getChildContext && (i2 = m$1(m$1({}, i2), h2.getChildContext())),
          x2 &&
            !p2 &&
          ...
          (f2 = L(n2, g(A2) ? A2 : [A2], u2, t2, i2, r2, o2, e2, f2, c2, a2)),
          (h2.base = u2.__e),
          (u2.__u &= -161),
          h2.__h.length && e2.push(h2),
      ...
      null == o2 && u2.__v == t2.__v
        ...
        : (f2 = u2.__e = G(t2.__e, u2, t2, i2, r2, o2, e2, c2, a2));
  ...
  function G(u2, t2, i2, r2, o2, e2, f2, c2, a2) {
    ...
    if (null == x2) m2 === k2 || (c2 && u2.data == k2) || (u2.data = k2);
      ...
      if (
        ((e2 = "textarea" == x2 && null != k2.defaultValue ? null : e2 && n.call(u2.childNodes)),
        !c2 && null != e2)
      )
          ...
          "children" == s2
            ...
            : "dangerouslySetInnerHTML" == s2
              ...
              : "value" == s2
                ...
                : "checked" == s2
                  ? (_2 = y2)
                  : (c2 && "function" != typeof y2) || m2[s2] === y2 || N(u2, s2, y2, m2[s2], o2));
      if (h2)
        (c2 ||
          (p2 && (h2.__html == p2.__html || h2.__html == u2.innerHTML)) ||
      ...
      (c2 && "textarea" != x2) ||
        ...
        "progress" == x2 && null == w2
          ...
          : null != w2 &&
            (w2 !== u2[s2] || ("progress" == x2 && !w2) || ("option" == x2 && w2 != m2[s2])) &&
            N(u2, s2, w2, m2[s2], o2),
        (s2 = "checked"),
        null != _2 && _2 != u2[s2] && N(u2, s2, _2, m2[s2], o2));
    }
    return u2;
  }
  function J(n2, u2, t2) {
  ...
  function K(n2, u2, t2) {
    ...
    if (
      ...
      (i2 = n2.ref) && ((i2.current && i2.current != n2.__e) || J(i2, null, u2)),
      null != (i2 = n2.__c))
    ) {
  ...
  function R(u2, t2, i2) {
    ...
    (t2 == document && (t2 = document.documentElement),
      l$1.__ && l$1.__(u2, t2),
      (o2 = (r2 = false) ? null : t2.__k),
      (e2 = []),
      (f2 = []),
      q$1(
        t2,
        (u2 = t2.__k = k$1(S, null, [u2])),
        o2 || d$1,
        d$1,
        t2.namespaceURI,
        o2 ? null : t2.firstChild ? n.call(t2.childNodes) : null,
        e2,
        o2 ? o2.__e : t2.firstChild,
        r2,
        f2
      ),
      D$1(e2, u2, f2));
  ...
  ((n = w$1.slice),
    ...
    (C$1.prototype.setState = function (n2, l2) {
      var u2;
      ((u2 =
        null != this.__s && this.__s != this.state ? this.__s : (this.__s = m$1({}, this.state))),
        "function" == typeof n2 && (n2 = n2(m$1({}, u2), this.props)),
        n2 && m$1(u2, n2),
        null != n2 && this.__v && (l2 && this._sb.push(l2), A$1(this)));
    }),
    ...
    (c.__r = function (n2) {
      ...
      (i2 &&
        (u === r
          ? ((i2.__h = []),
            (r.__h = []),
            i2.__.some(function (n3) {
              (n3.__N && (n3.__ = n3.__N), (n3.u = n3.__N = void 0));
            }))
          : (i2.__h.some(z), i2.__h.some(B), (i2.__h = []), (t = 0))),
        (u = r));
    }),
  ...
  const RelationFilter = ({ activeRelation, onChange }) =>
    /* @__PURE__ */ u$1("div", {
      className: `${SCRIPT_ID}-relation-filter`,
      children: relationOptions.map((option) =>
        /* @__PURE__ */ u$1(
          "label",
          {
            className: `${SCRIPT_ID}-relation-option`,
            children: [
              /* @__PURE__ */ u$1("input", {
                type: "radio",
  ...
  const SearchBox = ({
    ...
    return /* @__PURE__ */ u$1("div", {
      ...
      children: [
        ...
        notice
          ? /* @__PURE__ */ u$1("div", {
              className: `${SCRIPT_ID}-search-notice`,
              children: notice,
            })
          : null,
      ],
  ...
  const StateView = ({ text, isError = false }) =>
    /* @__PURE__ */ u$1("div", {
      className: `${SCRIPT_ID}-state${isError ? ` ${SCRIPT_ID}-state-error` : ""}`,
      children: text,
    });
  ...
  const UserListItem = ({ user, selected = false, onSelect }) => {
    ...
    return /* @__PURE__ */ u$1("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ u$1("div", {
          className: `${SCRIPT_ID}-person-main`,
          children: [
            /* @__PURE__ */ u$1("a", {
            ...
            /* @__PURE__ */ u$1("div", {
              className: `${SCRIPT_ID}-meta`,
              children: user.meta || `UID ${user.mid}`,
            }),
          ],
        }),
  ...
  const UserListFooter = ({ loadingMore, hasMore, moreError, onRetry }) =>
    /* @__PURE__ */ u$1("div", {
      className: `${SCRIPT_ID}-list-footer`,
      children: moreError
        ? /* @__PURE__ */ u$1("button", {
            className: `${SCRIPT_ID}-list-retry`,
            type: "button",
            onClick: onRetry,
            children: [moreError, "，点击重试"],
          })
        : /* @__PURE__ */ u$1("div", {
            children: loadingMore ? "正在加载更多..." : hasMore ? "" : "没有更多了",
          }),
    });
  const UserList = ({
    users,
    ...
    /* @__PURE__ */ u$1("div", {
      className: `${SCRIPT_ID}-list-scroll`,
      "data-bili-share-to-friends-list-scroll": "true",
      children: [
        /* @__PURE__ */ u$1("ul", {
          className: `${SCRIPT_ID}-list`,
          children: users.map((user) =>
            /* @__PURE__ */ u$1(
              "li",
              {
                children: /* @__PURE__ */ u$1(UserListItem, {
                  user,
                  selected: user.mid === selectedMid,
                  onSelect,
                }),
              },
              user.mid
  ...
  const AllFriendsPanel = ({
    ...
    _(() => {
      ...
      const scrollRoot =
        (_a = panelRef.current) == null ? void 0 : _a.querySelector(LIST_SCROLL_SELECTOR);
      if (scrollRoot) {
    ...
    const getListScrollTop = q(() => {
      var _a, _b;
      return (
        ((_b = (_a = panelRef.current) == null ? void 0 : _a.querySelector(LIST_SCROLL_SELECTOR)) ==
        null
          ? void 0
          : _b.scrollTop) ?? 0
      );
    ...
    const loadRelationUsers = q(
      async (relation, { reset = false, keywordOverride = null } = {}) => {
        ...
        if (
          ...
          (!reset && displayState2.loaded && !displayState2.hasMore)
        ) {
          return;
        }
        ...
        try {
          ...
          setPageState(source, (state) => {
            if (useSearch && nextPage === 1) {
              return {
                ...state,
                users: relationState2.users.filter((user) =>
                  user.name.toLowerCase().includes(keyword2.toLowerCase())
                ),
                hasMore: false,
                loaded: true,
              };
    ...
    y(() => {
      ...
      const scrollRoot =
        (_b = panelRef.current) == null ? void 0 : _b.querySelector(LIST_SCROLL_SELECTOR);
      const sentinel =
        scrollRoot == null
          ? void 0
          : scrollRoot.querySelector("[data-bili-share-to-friends-list-sentinel]");
    ...
    return /* @__PURE__ */ u$1("div", {
      className: `${SCRIPT_ID}-panel`,
      ref: panelRef,
      children: [
        /* @__PURE__ */ u$1(RelationFilter, {
          activeRelation,
          onChange: (relation) => {
  ...
  const DialogHeader = ({ title, onClose, disabled = false }) =>
    /* @__PURE__ */ u$1("div", {
      className: `${SCRIPT_ID}-header`,
      children: [
  ...
  const EntryButton = ({ onClick }) =>
    /* @__PURE__ */ u$1("button", {
      ...
      children: [
        /* @__PURE__ */ u$1("span", {
          className: `${SCRIPT_ID}-entry-icon`,
          "aria-hidden": "true",
  ...
  const VideoCover = ({ video }) => {
    ...
    if (!(video == null ? void 0 : video.pic) || loadFailed) {
      return /* @__PURE__ */ u$1("div", {
        className: `${SCRIPT_ID}-cover ${SCRIPT_ID}-cover-placeholder`,
        children: loadFailed ? "封面加载失败" : "读取中",
      });
    }
  ...
  const VideoPreview = ({ video }) =>
    /* @__PURE__ */ u$1("div", {
      className: `${SCRIPT_ID}-video`,
      children: [
        /* @__PURE__ */ u$1(VideoCover, { video }),
        /* @__PURE__ */ u$1("div", {
          children: [
            /* @__PURE__ */ u$1("p", {
              className: `${SCRIPT_ID}-video-title`,
              children: (video == null ? void 0 : video.title) || "当前视频",
            }),
            /* @__PURE__ */ u$1("div", {
              className: `${SCRIPT_ID}-video-author`,
              children: (video == null ? void 0 : video.ownerName)
                ? `UP主：${video.ownerName}`
                : "",
            }),
          ],
  ...
  const ShareDialog = ({ dialog, video, nav = null, status = "", error = "" }) => {
    ...
    const renderBody = () => {
      ...
      return /* @__PURE__ */ u$1(S, {
        children: [
          ...
          /* @__PURE__ */ u$1(RecentRecipientsPanel, {
            active: activeTab === "recent",
            selectedMid: selectedUser == null ? void 0 : selectedUser.mid,
            onSelect: handleUserSelect,
          }),
          /* @__PURE__ */ u$1(AllFriendsPanel, {
    ...
    return /* @__PURE__ */ u$1("div", {
      className: `${SCRIPT_ID}-dialog-content`,
      children: [
        /* @__PURE__ */ u$1(DialogHeader, {
          title: "分享给 B站好友",
          disabled: sending,
          onClose: handleClose,
        }),
  ...
  const renderDialog = ({ dialog, video, nav = null, status = "", error = "" }) => {
    R(/* @__PURE__ */ u$1(ShareDialog, { dialog, video, nav, status, error }), dialog);
  };
