...
更新时间：2026年6月11日01:46:28

更新内容：

1、复用 shared 文件读取工具，减少本地 FileReader 封装逻辑。

## V0.3.4

更新时间：2026年6月11日01:12:14

更新内容：

1、重构导入 Markdown 文档的脚本结构，拆分 DOM 初始化、文件读取、格式转换、标题填充和剪贴板复制逻辑。

2、复用 shared 中的 DOM、样式和剪贴板工具，增强顶层窗口判断、元素等待、文件读取失败和复制失败等边界处理。

3、将导入按钮样式拆分到独立 CSS 文件中维护，并移除未使用的 jQuery、axios 外部依赖。
